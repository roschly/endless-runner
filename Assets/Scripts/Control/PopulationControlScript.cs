...
public class PopulationControlScript : MonoBehaviour {
	...
	private string filePath = "C:/Users/Roschly/Documents/GitHub/endless-runner/Data/";
	...
	public void testNextGenome(){
		...
		Application.LoadLevel("TutorialBoxScene");
	}

	public void testHasEnded(){
		// hack, champion fitness cant go down
		if (index == 0) {
	...
	public void saveDatFile(){
		...
		FileStream file = File.Create (Application.dataPath + "/../Data/PopulationData.dat");
